        ...
        <div>
            ...
            { !user.email ?
                ...
                <div className="mb-5">
                    ...
                    <Link className='text-decoration-none text-white' to="/completeprofile"><u><button onClick={logout} className='btn btn-secondary'>Complete Profile</button></u></Link>

                    <Link className='text-decoration-none text-white' to="/"><u><button onClick={logout} className='btn btn-secondary'>Logout</button></u></Link>
                </div>
            }
